...
df_mean_test = pd.read_csv("mean_for_90_sliced_test_design_800_events_design", index_col=0)
...
theta_validation = design_validation.iloc[0:90]
...
print(theta.shape)
print(theta_validation.shape)
print(design_b0.shape)
print(design_b1.shape)

frames = [df_mean, df_mean_b0, df_mean_b1]
feval = pd.concat(frames)

frames = [theta, design_b0, design_b1]
