...
frames = [df_mean, df_mean_b0, df_mean_b1, df_mean_b2, df_mean_b3]
feval = pd.concat(frames)

frames = [theta, design_b0, design_b1, design_b2, design_b3]
...
theta_in = pd.DataFrame(np.round(theta[in_id, :], 4), columns = ['Pb_Pb',
                                                                 ...
                                                                 'Asym_peak',
                                                                 'R'])
theta_in.to_csv(r'add_design_021422.txt', header=True, index=None, sep=' ', mode='a')
